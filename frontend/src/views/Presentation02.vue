  ...
  <main class="presentation-page">
    <section class="deck" :class="activeSlide.theme">
      <header class="deck-toolbar">
        <div>
          <span class="deck-label">Projektpräsentation - Zeiterfassung</span>
        </div>
        <div class="deck-actions">
          ...
          <button type="button" class="icon-button" title="Nächste Folie" @click="nextSlide">
            &gt;
          </button>
        </div>
      </header>
...
const slides = [
  {
    ...
    lead: "Eine Webanwendung für Arbeitszeiten, Dienstplanung, Urlaubsanträge, Berichte und Administration.",
    theme: "theme-cover",
    visual: "system",
    people: [
  ...
  },
  {
    ...
    visual: "modules",
    points: [
      { mark: "01", title: "Zeit sparen", text: "Arbeitszeiten werden direkt digital erfasst und können sofort ausgewertet werden." },
      { mark: "02", title: "Transparenz schaffen", text: "Mitarbeitende und Admins sehen Status, Anträge und Berichte an einem Ort." },
  ...
  },
  {
    ...
    lead: "Das Frontend ist eine Vue Single Page Application mit klarer Navigation und rollenabhängigen Ansichten.",
    theme: "theme-blue",
    visual: "frontend",
    points: [
  ...
  },
  {
    ...
    lead: "Das Backend verarbeitet API-Anfragen, prüft Sicherheit, ruft Services auf und speichert Daten in MongoDB.",
    theme: "theme-dark",
    visual: "backend",
    points: [
      { mark: "API", title: "Express.js", text: "REST-Endpunkte für Auth, User, Arbeitszeiten, Urlaub, Reports und Systemstatus." },
      { mark: "SEC", title: "Sicherheit", text: "JWT, bcrypt, Security Headers, CORS-Regeln und zentrale Fehlerbehandlung." },
      { mark: "OPS", title: "Betrieb", text: "Health-Checks, Logging, Monitoring und sauberes Shutdown-Verhalten für Deployment." },
    ],
  },
  {
    kicker: "Datenmodell",
    ...
    visual: "data",
    points: [
      { mark: "DB", title: "MongoDB", text: "Flexible NoSQL-Datenbank für Arbeitszeiten, Benutzer, Abteilungen und Anträge." },
      { mark: "LOG", title: "Nachvollziehbarkeit", text: "Logs und Statusfelder machen Entscheidungen und Fehler später nachvollziehbar." },
    ],
  },
  {
    kicker: "Technologien",
    title: "Welche Technologien wurden verwendet?",
    lead: "Der Stack ist modern, gut testbar und für lokales Arbeiten sowie Cloud-Deployment geeignet.",
    theme: "theme-tech",
    visual: "stack",
    points: [
      { mark: "FE", title: "Vue, Vite, Bootstrap", text: "Schnelle Entwicklung, responsive Oberfläche und modulare Komponenten." },
      { mark: "BE", title: "Node, Express, Mongoose", text: "Strukturierte API-Schicht mit Datenzugriff über Modelle und Services." },
      { mark: "QA", title: "Jest und Supertest", text: "Unit- und Integrationstests für kritische Backend-Funktionen." },
    ],
  },
  {
    kicker: "Live Demo",
    title: "Frontend live zeigen",
    lead: "Hier kann die echte Anwendung direkt in der Präsentation gezeigt werden: Login, Dashboard, Zeiterfassung, Urlaub und Reports.",
    theme: "theme-live",
    visual: "live",
    points: [
      { mark: "1", title: "Login", text: "Benutzer anmelden und rollenabhängige Navigation zeigen." },
      { mark: "2", title: "Zeiterfassung", text: "Arbeitsstart, Pause, Ende und Tagesübersicht demonstrieren." },
  ...
  },
  {
    kicker: "Fazit",
    title: "Ergebnis",
    lead: "Das Projekt zeigt eine vollständige Webanwendung mit Frontend, Backend, Datenbank, Sicherheit, Tests und Deployment-Vorbereitung.",
    theme: "theme-finish",
    visual: "system",
    points: [
      { mark: "OK", title: "Funktional", text: "Die wichtigsten Abläufe der Zeiterfassung sind digital abgebildet." },
...
const technologies = [
  ...
  { area: "Datenbank", name: "MongoDB", use: "Persistenz über Mongoose" },
  { area: "Auth", name: "JWT + bcrypt", use: "Login und Passwortschutz" },
  { area: "Tests", name: "Jest + Supertest", use: "Backend-Qualitätssicherung" },
];
